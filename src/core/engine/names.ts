...
export const LEGENDARY_PLAYERS: StarEntry[] = [
  ...
  { name: 'Diego Maradonno', position: 'MF', secondary: ['ST'], overall: 92 },
  ...
  { name: 'Ronaldinho Gauchito', position: 'FL', secondary: ['MF'], overall: 90 },
  ...
  { name: 'Ricardo Kakao', position: 'MF', secondary: ['FL'], overall: 88 },
  ...
  { name: 'Neymar Junius', position: 'FL', secondary: ['ST'], overall: 88 },
  ...
  { name: 'Ruud Gullito', position: 'MF', secondary: ['ST'], overall: 87 },
...
export const GOLD_PLAYERS: StarEntry[] = [
  ...
  { name: 'Achraf Hakimo', position: 'FB', overall: 85 },
  ...
  { name: 'Reece Jamez', position: 'FB', overall: 83 },
  { name: 'Theo Hernandes', position: 'FB', overall: 83 },
  ...
  { name: 'Alphonso Davios', position: 'FB', overall: 82 },
  ...
  { name: 'Pau Cubarso', position: 'CB', overall: 81 },
  { name: 'Milan Skrinar', position: 'CB', overall: 81 },
  { name: 'Fede Dimarco', position: 'FB', overall: 81 },
  ...
  { name: 'Kyle Walkman', position: 'FB', overall: 80 },
  { name: 'Alex Grimando', position: 'FB', overall: 80 },
  ...
  { name: 'Jerry Frimpo', position: 'FB', overall: 79 },
  { name: 'Alejandro Balde', position: 'FB', overall: 79 },
  ...
  { name: 'Marc Cucurelo', position: 'FB', overall: 78 },
